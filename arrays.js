...
console.log('samenums1 ',samenums1); samenums1[0] = 400;
...
console.log('nums3 ',nums3) nums3.sort(compare); 
...
var curve = function(grade){ return grade += 5; }

var newGrades = grades.map(curve)

console.log('newGrades ',newGrades);

var first = function(grade){ return grade.toString()[0]; }

var newGrades0 = newGrades.map(first);

console.log('newGrades0 ',newGrades0.join(''));

var nums6 = []; for (var i = 0; i < 20; ++i) { nums6[i] = i+1; }
...
var passing = function(number){ return number >= 60; }
